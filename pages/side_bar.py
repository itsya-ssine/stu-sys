...
from .add import Add
from pages.remove import Remove
...
class Sidebar(ctk.CTkFrame):
    def __init__(self, master, home):
        ...
        self.add_frame = Add(master, self.students)
        self.remove_frame = Remove(master)
        self.modify_frame = Modify(master)
        ...
        self.pages = [home, self.students, self.add_frame, self.remove_frame, self.modify_frame] 
        ...
        menu = ["Home", "Students", "Add Student", "Remove Student", "Modify"] 
