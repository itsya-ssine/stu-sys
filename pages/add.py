...
class Add(ctk.CTkFrame):
    ...
    def get_entries(self):
        ...
        if email == "" or "@" not in email:
            self.incorrect.configure(text="Email must be valid!")
            return None
        if major == "":
            self.incorrect.configure(text="Major cannot be empty!")
            return None
        if sexe == "other":
    ...
    def add_student(self):
        ...
        stud = Student(name1, name2, student_id, sexe, email, major)
        
        success = add_stud_file(stud)
        ...
        if success:
            ...
            self.incorrect.configure(text="Error adding student!", text_color="red")
